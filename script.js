...
const CHARLAS = [
  ...
  {id:'MIE-4', day:'MIE', time:'12:30 PM - 01:30 PM', title:'Técnicas anestésicas locorregionales ecoguiadas: alcances y limitaciones.', speaker:'Dr. Edgardo Pardo'},
  {id:'MIE-5', day:'MIE', time:'02:30 PM - 04:00 PM', title:'Taller: Implementación de un programa de rehabilitación física en la clínica de pequeños animales', speaker:'MV. Felipe Calle'},
  {id:'JUE-1', day:'JUE', time:'08:30 AM - 09:30 AM', title:'Punción con balón en fístulas salivales: una opción terapéutica efectiva.', speaker:'Dr. Gino Pilco'},
  {id:'JUE-2', day:'JUE', time:'09:40 AM - 10:40 AM', title:'Estenosis esofágica benigna: abordaje mínimamente invasivo con balón de dilatación.', speaker:'Dr. Carlos Enríquez'},
  {id:'JUE-3', day:'JUE', time:'10:50 AM - 11:50 AM', title:'Dispositivos de asistencia ventricular izquierda: aplicaciones en la clínica de pequeños animales.', speaker:'Dr. Carlos Enríquez'},
  {id:'JUE-4', day:'JUE', time:'12:00 PM - 01:00 PM', title:'Manejo de heridas complejas: el ABC de la reconstrucción con colgajos.', speaker:'Dra. Nathaly Céspedes'},
  {id:'JUE-5', day:'JUE', time:'01:10 PM - 02:10 PM', title:'Abordaje clínico y terapéutico de las intoxicaciones más frecuentes en pequeños animales.', speaker:'Dr. Edgardo Pardo'},
  {id:'JUE-6', day:'JUE', time:'02:20 PM - 03:20 PM', title:'Actualización en el diagnóstico y manejo de la Leishmaniasis canina.', speaker:'Dra. Nathaly Céspedes'},
  {id:'VIE-1', day:'VIE', time:'08:00 AM - 09:30 AM', title:'Taller: Abordaje del paciente oncológico: una mirada integral.', speaker:'Dra. Nathaly Céspedes'},
  {id:'VIE-2', day:'VIE', time:'09:40 AM - 10:40 AM', title:'Manejo del dolor crónico en el perro geriátrico: alternativas más allá de los AINEs.', speaker:'Dr. Jorge Forero'},
  {id:'VIE-3', day:'VIE', time:'10:50 AM - 11:50 AM', title:'Diagnóstico por imagen de las principales alteraciones del tracto urinario en pequeños animales.', speaker:'Dr. Gino Pilco'},
  {id:'VIE-4', day:'VIE', time:'12:00 PM - 01:00 PM', title:'Implementación de un plan de medicina preventiva en la clínica: vacunación, desparasitación y bienestar.', speaker:'Leslie Uribe'},
  {id:'VIE-5', day:'VIE', time:'01:10 PM - 02:10 PM', title:'Trastornos del comportamiento en perros y gatos: un enfoque práctico para el médico veterinario.', speaker:'Leslie Uribe'},
  {id:'VIE-6', day:'VIE', time:'02:20 PM - 03:20 PM', title:'Manejo integral del paciente politraumatizado: priorización y estabilización.', speaker:'Dr. Edgardo Pardo'},
];
